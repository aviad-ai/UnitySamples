...
using UnityEngine.Rendering;
	...
	/// </summary>
	[ExecuteInEditMode]
	public class LowHealthController_URP : MonoBehaviour {
		/// <summary>
		...
		[SerializeField] private Material damageOverlay;
		...
		public void UpdateShaderProperties() {
			...
			ensureMaterial();
			damageOverlay.SetFloat("_DoubleVision", health < doubleVisionStartsAt ? 1.0f:0.0f);
			damageOverlay.SetFloat("_effectScale", 1f-health);
			damageOverlay.SetFloat("_clPercent", clPercent);
			damageOverlay.SetFloat("_clRed",clRed);
